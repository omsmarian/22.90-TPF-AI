function Robot_Sim(x_ini, y_ini, x_fin, y_fin)
% ROBOT_SIM Simula el robot dibujando una línea desde (x_ini, y_ini) a (x_fin, y_fin)
%
%   Ejemplo de uso:
%       Robot_Sim(0.15, -0.05, 0.15, 0.05);

    %% 1. Definición del Robot (Interna de la función)
    ...
    % Asignamos los argumentos de entrada a las variables internas
    x_hoja_inicial = x_ini; 
    y_hoja_inicial = y_ini; 
    x_hoja_final   = x_fin; 
    y_hoja_final   = y_fin; 
